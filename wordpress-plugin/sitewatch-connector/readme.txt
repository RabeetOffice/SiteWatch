...
* Optional PHP warning and deprecation summary, switched on in SiteWatch. The handler only counts; errors are logged and shown as before.
* Remembers the address SiteWatch's checks come from, for allow-listing when a firewall blocks them.
